...
export default function ContactPage() {
  ...
  return (
    <main>
      <PageHero
        eyebrow="Kontak kami"
        title={<>Mari diskusikan kebutuhan <span className="gradient-text">teknis Anda.</span></>}
      ...
      >
        <div className="mt-8 flex flex-wrap gap-3">
          <span className="site-chip"><Clock3 size={14} /> Respon pada jam kerja</span>
          <span className="site-chip"><MessageCircle size={14} /> Konsultasi awal</span>
        </div>
      </PageHero>
      ...
      <section className="section-block section-shell pt-0">
        <div className="contact-layout">
          <div className="contact-stack">
            <motion.div className="site-card contact-info-card" data-aos="fade-right" whileHover={{ x: 4 }}>
            ...
            <motion.div className="site-card contact-info-card" data-aos="fade-right" data-aos-delay="80" whileHover={{ x: 4 }}>
            ...
            <motion.div className="site-card contact-info-card" data-aos="fade-right" data-aos-delay="160" whileHover={{ x: 4 }}>
            ...
            <div className="site-card p-6" data-aos="fade-up" data-aos-delay="220">
              <h3 className="text-sm font-bold">Informasi yang membantu kami merespons lebih cepat</h3>
          ...
          <motion.div className="site-card contact-form" data-aos="fade-left">
            <div className="flex items-start justify-between gap-6">
              <div>
                ...
                <h2 className="text-3xl font-black tracking-[-0.04em]">Ceritakan kebutuhan Anda.</h2>
                <p className="mt-3 text-sm leading-6 text-[var(--text-secondary)]">Lengkapi form berikut. Data hanya digunakan untuk komunikasi terkait permintaan Anda.</p>
              </div>
              <span className="contact-icon hidden sm:grid"><Send size={20} /></span>
            </div>

            <form className="form-grid" onSubmit={handleSubmit}>
              <div className="form-field">
                <label htmlFor="name">Nama</label>
                <input id="name" name="name" required className="site-input" placeholder="Nama lengkap" />
              </div>
              <div className="form-field">
                <label htmlFor="email">Email</label>
                <input id="email" name="email" type="email" required className="site-input" placeholder="nama@email.com" />
              </div>
              ...
              <div className="form-field form-field-full">
                ...
                <textarea id="message" name="message" rows={6} required className="site-input resize-none" placeholder="Jelaskan produk, layanan, atau kebutuhan teknis Anda..." />
              </div>
              <div className="form-field-full flex flex-col gap-4 sm:flex-row sm:items-center">
                ...
                <span className="text-xs leading-5 text-[var(--text-muted)]">Kami akan menghubungi Anda kembali pada jam operasional.</span>
              </div>
            </form>

            {submitted && (
              <div className="form-success" role="status">
                <CheckCircle2 size={17} /> Pesan sudah dicatat pada tampilan. Hubungkan form ke layanan email/API untuk pengiriman otomatis.
              </div>
            )}
          </motion.div>
        </div>
