  ...
  return (
    <div className="border-t border-white/10 py-32">
      <div className="max-w-7xl mx-auto px-8 grid grid-cols-1 md:grid-cols-12 gap-12">
        ...
        <div className="md:col-span-1 text-purple-500 font-mono text-sm pt-2">
          {id}
        </div>
        ...
        <div className="md:col-span-4 flex items-end justify-end">
          <a href="#" className="group flex items-center gap-4 text-sm uppercase tracking-widest font-bold">
