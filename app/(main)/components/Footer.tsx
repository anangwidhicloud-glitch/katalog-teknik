...
function SocialGlyph({ kind }: { kind: 'tiktok' | 'facebook' | 'youtube' | 'instagram' }) {
  if (kind === 'facebook') {
    return <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M24 12.073C24 5.405 18.627 0 12 0S0 5.405 0 12.073c0 6.026 4.388 11.02 10.125 11.927v-8.437H7.078v-3.49h3.047V9.414c0-3.025 1.792-4.697 4.533-4.697 1.312 0 2.686.236 2.686.236v2.97H15.83c-1.491 0-1.956.93-1.956 1.885v2.265h3.328l-.532 3.49h-2.796V24C19.612 23.093 24 18.1 24 12.073z" /></svg>;
  }
  if (kind === 'youtube') {
    return <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M23.5 6.2a3 3 0 0 0-2.1-2.15C19.5 3.55 12 3.55 12 3.55s-7.5 0-9.4.5A3 3 0 0 0 .5 6.2C0 8.08 0 12 0 12s0 3.92.5 5.8a3 3 0 0 0 2.1 2.15c1.9.5 9.4.5 9.4.5s7.5 0 9.4-.5a3 3 0 0 0 2.1-2.15c.5-1.88.5-5.8.5-5.8s0-3.92-.5-5.8zM9.55 15.57V8.43L15.82 12l-6.27 3.57z" /></svg>;
  }
  if (kind === 'instagram') {
    return <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true"><rect x="2" y="2" width="20" height="20" rx="5" /><circle cx="12" cy="12" r="4" /><circle cx="17.5" cy="6.5" r="1" fill="currentColor" stroke="none" /></svg>;
  }
  return <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M12.53.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.02 1.63 4.16 1.02 1.11 2.46 1.62 3.87 1.78v4.03a9.2 9.2 0 0 1-5.43-1.64c.01 2.91.01 5.82-.01 8.73-.16 3.48-3 6.47-6.47 6.78-3.47.45-6.93-1.58-8.24-4.82-1.6-3.82.28-8.54 4.12-10.1a8.18 8.18 0 0 1 4.61-.45v4.13c-1.42-.46-3.12-.06-4.03 1.16-1.13 1.4-.9 3.62.48 4.77 1.33 1.21 3.63 1.1 4.82-.25.41-.47.68-1.07.7-1.7.07-5.52-.02-11.03.04-16.56z" /></svg>;
}
        ...
        <div className="footer-grid">
          ...
          <div data-aos="fade-up" data-aos-delay="240">
            ...
            <div className="footer-hours">
              <p><span>Senin – Jumat</span><strong>09.00 – 16.30</strong></p>
              <p><span>Sabtu</span><strong>09.00 – 15.00</strong></p>
              <p><span>Minggu</span><strong className="footer-closed">Libur</strong></p>
            </div>
          </div>
        </div>
