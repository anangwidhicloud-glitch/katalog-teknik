...
const securityItems = [
  {
    ...
    description:
      "Sesi tidak dapat dibaca langsung oleh JavaScript pada browser.",
    icon: LockKeyhole,
  },
  {
    title: "Masa aktif 8 jam",
    description:
      "Sesi admin memiliki batas waktu dan perlu login kembali setelah berakhir.",
    icon: Clock3,
  },
  {
    title: "Kredensial di server",
    description:
      "Email, kata sandi, dan secret tidak dikirim sebagai variabel publik.",
    icon: ServerCog,
  },
];
      ...
      <section className="admin-panel relative overflow-hidden rounded-[26px] px-6 py-7 sm:px-8">
        ...
        <div className="relative max-w-3xl">
          ...
          <p className="mt-2 max-w-2xl text-sm leading-6 text-slate-400">
            Halaman ini menampilkan cara akses admin dilindungi. Nilai email,
            kata sandi, dan secret tidak ditampilkan untuk menjaga keamanan.
          </p>
        </div>
      </section>
      ...
      <section className="grid gap-4 md:grid-cols-3">
        {securityItems.map((item) => {
          ...
          return (
            <article
              key={item.title}
              className="admin-panel rounded-[22px] p-5"
            >
        ...
        <div className="admin-panel overflow-hidden rounded-[24px]">
          <div className="border-b border-white/[0.07] px-5 py-5 sm:px-6">
            ...
            <p className="mt-1 text-xs text-slate-500">
              Variabel berikut harus tersedia pada lingkungan aplikasi.
            </p>
          </div>
          ...
          <div className="divide-y divide-white/[0.06]">
            {[
              ...
              [
                "ADMIN_PASSWORD",
                "Kata sandi administrator yang kuat dan unik.",
              ],
              [
                "ADMIN_AUTH_SECRET",
                "Secret panjang untuk menandatangani token sesi.",
              ],
              ...
              >
                <div>
                  <code className="text-xs font-semibold text-sky-200">
                    {name}
                  </code>
        ...
        <div className="admin-panel rounded-[24px] p-5 sm:p-6">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="mt-2 text-xs leading-6 text-slate-500">
                Pada komputer lokal, ubah nilai di{" "}
                <code className="text-slate-300">.env.local</code>. Saat deploy
                di Vercel, ubah melalui menu Environment Variables pada
                pengaturan proyek.
              </p>
            </div>
          </div>
          ...
          <div className="mt-6 rounded-2xl border border-amber-300/10 bg-amber-400/[0.055] p-4">
            <div className="flex items-start gap-3">
              ...
              <p className="text-xs leading-5 text-amber-100/65">
                Jangan menambahkan prefix{" "}
                <code className="text-amber-100">NEXT_PUBLIC_</code> pada
                kredensial karena nilai tersebut dapat dikirim ke browser.
              </p>
            </div>
          </div>
        </div>
